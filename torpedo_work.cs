...
{    
    if(argument != "Start")
    {
        ...
        PrevPos = new Vector3D(array[0],array[1],array[2]);
    }
    TickCount++;
    Prog = GridTerminalSystem.GetBlockWithName("Prog") as IMyProgrammableBlock;      
    ...
    if (RemCon==null)    
        ...
        Prog.TryRun(TickCount.ToString()+" "+PrevPos.ToString());       
}    
